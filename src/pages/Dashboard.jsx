...
function Dashboard() {
  return (
    <Fade in timeout={900}>
      ...
      >
        {/* خلفية محاسبية عصرية باستخدام رموز وأيقونات محاسبة شفافة */}
        <Box
          sx={{
            position: 'absolute',
            top: 30,
        ...
        <Typography variant="body1" sx={{
          ...
          مرحباً بكم في الموقع الرسمي للمحاسب القانوني علاء محمد عبدالغني. خبرة واسعة في الإدارة المالية، المراجعة، الاستشارات الضريبية، تقييم الأصول وتصفيتها. أساعد الشركات والأفراد على تحقيق أهدافهم المالية بدقة واحترافية وشفافية.
        </Typography>
        <Typography variant="body1" sx={{
          ...
          يمكنك زيارة صفحة التواصل وكتابة رسالتك أو استفسارك وسيتم الرد عليك في أقرب وقت.
        </Typography>
      </Paper>
    </Fade>
  );
